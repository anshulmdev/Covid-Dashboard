...
import nuxt_plugin_pluginrouting_d3ac6946 from 'nuxt_plugin_pluginrouting_d3ac6946' // Source: .\\nuxt-i18n\\plugin.routing.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_pluginrouting_d3ac6946 === 'function') {
    await nuxt_plugin_pluginrouting_d3ac6946(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_85bdb59c === 'function') {
    await nuxt_plugin_pluginmain_85bdb59c(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_workbox_128f0578 === 'function') {
    await nuxt_plugin_workbox_128f0578(app.context, inject)
  }
